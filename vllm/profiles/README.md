...
| `RedHatAI--Muse-Glimmer-30B-NVFP4` | ✅ | NVFP4 ~22 GiB, **empfohlene Variante auf GB10** (Rezept). Gemessen 2026-08-13: Start 331 s, TTFT 0.33–0.43 s, 12.3 tok/s (CUDA-Graphs) — BF16 kam eager nur auf ~4 tok/s. Gleiches Spezial-Image |
